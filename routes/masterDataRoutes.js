...
router.get('/tags', requireAuth, masterDataController.getTags);
router.post('/api/tags/rename', requireAuth, express.json(), masterDataController.renameTag);
router.delete('/api/tags/:tag', requireAuth, masterDataController.deleteTag);
